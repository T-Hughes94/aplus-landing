...
interface CartCreateBody {
  variantId: string;     // Storefront variant GID (used as merchandiseId)
  quantity?: number;     // defaults to 1 on the server
}
...
/** Generic type guard that preserves the base type while asserting an errors array */
...
export async function POST(req: NextRequest) {
  try {
    ...
    // Debug if needed during integration
