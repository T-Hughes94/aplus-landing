...
export const metadata: Metadata = {
  ...
  description:
    "Shipping details for A Plus Truffles: weekly order deadlines, production times, USPS Priority Mail, local pickup, warm weather protocol, and returns policy.",
  keywords: [
    "A Plus Truffles",
    "The Best Chocolate",
    "shipping chocolate",
  ...
  openGraph: {
    title: "Shipping & Fulfillment | A Plus Truffles",
    description:
      "How we ship handcrafted vegan truffles—order deadlines, production time, USPS Priority, pickup, warm weather protocol, and returns.",
    url: "/shipping",
    images: [
      {
  ...
  twitter: {
    ...
    title: "Shipping & Fulfillment | A Plus Truffles",
    description:
      "Everything you need to know about shipping, pickup, warm weather protocol, and returns.",
  },
...
const FAQ = [
  ...
  },
  {
    ...
    a: "Each batch is handcrafted and typically requires about 3 days to complete and a minimum 3 week notice for custom orders for peak freshness and quality.",
  },
  {
    q: "Warm Weather Shipping",
    a: "From April through mid-October—or whenever transit temps exceed 74°F—we use insulated packaging and gel packs to protect your order. A $3.50 Cool-Ship fee may apply. Please ensure someone can bring the package inside upon delivery to prevent melting.",
  },
  {
    q: "How do you ship?",
  ...
  {
    q: "Returns & Refunds",
    a: "Because our products are consumable/perishable, we’re not able to accept returns, issue refunds, or reship orders. We appreciate your understanding and will always do our best to make your experience outstanding. If there’s an issue with your order, please contact us right away via our Contact page.",
  },
] as const;
...
export default function ShippingPage() {
  ...
  const webPageLd = {
    ...
    url: `${base}/shipping`,
    description:
      "Order deadlines, production time, USPS Priority shipping, local pickup, warm weather protocol, and returns for A Plus Truffles.",
  };
  ...
  return (
    <>
      ...
      <main
        id="main-content"
        className="bg-black text-white font-custom"
        role="main"
      >
        <Header />
        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center justify-center space-y-6 max-w-4xl mx-auto">
            ...
            <p className="text-lg md:text-2xl text-white/90 max-w-2xl">
              How we ensure your handcrafted truffles arrive fresh, beautiful,
              and on time.
            </p>
            ...
            {FAQ.map(({ q, a }) => (
              <article key={q}>
                ...
                <p>
                  {q === "Returns & Refunds" ? (
                    <>
                      Because our products are consumable/perishable, we’re not
                      able to accept returns, issue refunds, or reship orders.
                      We appreciate your understanding and will always do our
                      best to make your experience outstanding. If there’s an
                      issue with your order, please{" "}
                      <Link
                        href="/contact"
                        className="underline decoration-[#ca8f70] underline-offset-4 hover:text-[#f8b870]"
                      >
                        contact us
                      </Link>{" "}
                      right away.
        ...
        >
          ...
          <p className="text-white mt-4 text-lg md:text-xl">
            Visit our contact or shop page to get started. We&apos;re excited to
