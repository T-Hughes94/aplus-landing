...
const Footer = () => {
  return (
    <footer className="relative bg-black border border-[#FFD700] text-white p-8 md:p-12">
      <div className="max-w-6xl mx-auto grid gap-8 text-center md:text-left md:grid-cols-3">
        
        {/* Company Info */}
        <div className="space-y-4">
          <h2 className="text-2xl text-purple-600 font-bold">A Plus Truffles</h2>
        ...
        <div className="space-y-2 md:space-y-4">
          <h3 className="text-xl text-emerald-600 font-semibold">Quick Links</h3>
        ...
        {/* Our Gallery */}
        <div className="space-y-4">
          <h3 className="text-xl text-purple-600 font-semibold">Our Gallery</h3>
